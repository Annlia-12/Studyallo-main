...
const StudyBuddy: React.FC = () => {
  ...
  const [studySessions, setStudySessions] = useState<StudySession[]>([
    ...
    },
    {
      ...
      location: 'Science Building - Study Hall',
      date: '2025-01-21',
      time: '10:00',
      duration: 180,
      author: 'Mike Johnson',
      description: 'Review session for upcoming midterm. Focus on reaction mechanisms.',
      participants: 3,
      maxParticipants: 6,
    },
    {
      ...
      duration: 90,
      author: 'Emma Davis',
      description: 'Integration by parts and series convergence problems.',
      participants: 1,
      maxParticipants: 3,
    },
  ]);
